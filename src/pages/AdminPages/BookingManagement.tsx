...
import CompactBookingCalendar from "../../components/AdminComponents/BookingComponents/CompactBookingCalendar"
...
const BookingManagement = () => {
  ...
  return (
    <Container maxWidth="lg" style={{ marginTop: "2rem" }}>
      ...
      {/* Compact Calendar directly in the page */}
      <CompactBookingCalendar />
    </Container>
  )
}

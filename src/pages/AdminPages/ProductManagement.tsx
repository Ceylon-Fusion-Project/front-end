...
//   TextField,
// } from "@mui/material";
// import { Add, Edit, Delete, FilterAlt, Check, Close } from "@mui/icons-material";
// import ProductForm from "@/components/AdminComponents/ProductForm";
// import AutoCompleteSearchBar from "@/components/AutoCompletedSearchBar";
// import FilterSideBar from "@/components/FilterSideBar";
// import api from "@/api/axiosInstance";
...
//     try {
//       const response = await api.patch(`/product/update-quantity/${productId}`, {
...
//       setSnackbarSeverity("error");
//     } finally {
//       setEditingQuantity({ id: null, value: 0 });
//       setSnackbarOpen(true);
//     }
//   };
...
//     const transformedProduct: Product = {
//       ...product,
//       productOrigin: product.productOrigin?.originID ?? null,
//       productActiveState: product.productActiveState ?? true,
//     };
//     setEditMode(true);
//     setCurrentProduct(transformedProduct);
...
//     try {
//       const idempotencyKey = uuidv4();
//       await deleteProduct(id, idempotencyKey);
//       setProducts((prev) => prev.filter((product) => product.productID !== id));
//       setSnackbarMessage("Product deleted successfully!");
//       setSnackbarSeverity("success");
//       setSnackbarOpen(true);
...
//                     <TableCell>${product.sellingPrice.toFixed(2)}</TableCell>
//                     <TableCell>
//                       {editingQuantity.id === product.productID ? (

...
const CertificationManagement = () => {
  ...
  const handleSave = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const newCertification: Certification = {
      ...
      certActiveState: new Date(formData.get("expiryDate") as string) >= new Date(),
          ...
          <Box sx={{ mb: 3 }}>
            ...
            <Box sx={{ display: 'flex', gap: 1 }}>
              <Button
                ...
                onClick={() => setFilters({ ...filters, activeOnly: !filters.activeOnly, expiredOnly: false })}
                sx={{
                  backgroundColor: filters.activeOnly ? '#a18658' : 'transparent',
              ...
              <Button
                ...
                onClick={() => setFilters({ ...filters, expiredOnly: !filters.expiredOnly, activeOnly: false })}
                sx={{
                  backgroundColor: filters.expiredOnly ? '#EF4444' : 'transparent',
                  color: filters.expiredOnly ? '#FFFFFF' : '#EF4444',
                  borderColor: '#EF4444',
                  '&:hover': {
                    backgroundColor: filters.expiredOnly ? '#DC2626' : '#FEE2E2',
                    borderColor: '#DC2626'
                  }
                }}
              >
